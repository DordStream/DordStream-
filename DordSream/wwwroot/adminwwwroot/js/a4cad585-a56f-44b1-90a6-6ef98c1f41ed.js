...
let messageService ={
    ...
    searchByDate: function () {
        connection.invoke("SearchByDate", $("#messageDate").val(), $("#mailTypeSelect").val());
    },
    searchByLabel: function (mailType) {
        connection.invoke("SearchByLabel", mailType);
    },
    saveMessage: function () {
        connection.invoke("Save", $("#From").val(), $("#Subject").val(), $("#content").val());
    },
    sendMessage: function () {
       
        connection.invoke("Send", $("#From").val(), $("#Subject").val(), $("#content").val(), subscriber.checked);
    }
};
