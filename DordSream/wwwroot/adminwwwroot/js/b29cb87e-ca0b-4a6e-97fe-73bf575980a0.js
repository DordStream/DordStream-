...
let commentService ={
    ...
    deleteAll: function () {
        if (postIds.length > 0 && commentIds.length > 0) {
            connection.invoke("DeleteAll", postIds, commentIds);
        }
        else {
    ...
    searchByDate: function () {
        connection.invoke("SearchByDate", $("#commentDate").val());
    },
    getComments: function () {
        connection.invoke("GetComments");
    },
    addComment: function () {
        connection.invoke("AddComment", $("#postId").val(), $("#fullName").val(), $("#message").val());
    }
};
